...
const ManualLocationSimulator: React.FC<ManualLocationSimulatorProps> = ({
  ...
  return (
    <div className='fixed right-4 bottom-4 z-50 w-[340px] rounded-xl border bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/80 shadow-lg p-4'>
      <div className='mb-3'>
